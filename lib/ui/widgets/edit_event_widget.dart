...
class EditEventWidget extends StatefulWidget {
  ...
  const EditEventWidget({super.key, required this.event});
...
class _EditEventWidgetState extends State<EditEventWidget> {
  ...
  late List<MapObject>? polylines;
  final List<MapObject> mapObjects = [];

  late Point myCurrentLocation;
  late Point najotTalim;
  ...
  void _editEvent() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        String fileUrl = widget.event['bannerUrl'];
        if (file != null) {
        ...
        print("Updating event in Firebase...");
        ...
        Navigator.pop(context); // To close the loading indicator
        Navigator.pop(context); // To go back to the previous screen
      } catch (e) {
        print("Error updating event: $e");
        Navigator.pop(
            context); // To close the loading indicator if there's an error
      }
    } else {
